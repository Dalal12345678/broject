...
//============================================//
var pom = new Audio("./Mouse-click-sounds.mp3");
let goodSound=new Audio("./Beautiful-Piano.mp3")
...
function Game(){
    ...
    function checkTreasure(){
        ...
        if(this.id == map[x][y]){
            score = score + 1000;
            document.getElementById("demo3").innerHTML = score;
            document.getElementById("demo4").innerHTML = "You story is unigue. It can only be forged by you.!";
